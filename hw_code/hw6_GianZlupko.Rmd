...
Next, I plot the PCA scores with a scatterplot matrix and display the contours of the bivariate densities on the diagonal panels. The findings suggest that the pottery data can be 

```{r}
library(MASS)
pairs(pca1$scores[, 1:3], upper.panel = 
        function(x, y) { 
          points(x, y)
          den <- MASS::kde2d(x, y)
